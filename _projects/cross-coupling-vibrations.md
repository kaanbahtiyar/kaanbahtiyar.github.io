...
description: "Trajectory pre-filtering that cancels axis-coupled inertial vibration in vertical machining centers, cutting coupled Z motion by ~80% while allowing faster axis acceleration."
card_metric: "80%"
card_metric_label: "↓ axis-coupled vibration · ~1 µm residual"
card_blurb: "Trajectory pre-filtering that cancels cross-axis coupling on a 3-axis machining center, driving residual Z motion from 6 µm down to ~1.2 µm."
card_image: "/images/projects/cross-coupling-vibrations/fig1_setup.png"
card_tags:
  - "ICPE 2024"
...
<div class="kb-result">
  <div class="kb-result-num">80%<small>↓</small></div>
  <div class="kb-result-text"><strong>Axis-coupled Z vibration reduced from 6 µm to ~1.2 µm (5× lower)</strong> on a vertical machining center, while enabling more aggressive axis acceleration for higher throughput.</div>
</div>

<div class="kb-hw">
  <span class="kb-hw-eyebrow">Built &amp; validated on real hardware</span>
  <div class="kb-hw-chips">
    <span>3-axis vertical machining center</span>
    <span>Accelerometers</span>
    <span>Laser encoder</span>
