---
title: "Data-driven feedforward control of active inertial dampers for high-performance vibration mitigation"
collection: publications
category: conference
pubtype: conf-abstract
permalink: /publication/inertial-damper-feedforward-aspe2024/
excerpt: "Iterative learning–based feedforward control of an active inertial damper that shapes the actuator signal to suppress transient vibrations in ultra-precision machine tools, achieving large peak-vibration reductions within actuator limits."
date: 2024-11-04
venue: "39th Annual Meeting of the American Society for Precision Engineering (ASPE)"
status: published
...
Abstract-reviewed extended abstract and oral presentation based on the  
[inertial damper control for vibration mitigation project](/projects/inertial-damper-control/).

The conference program is available at the  
[39th Annual Meeting of the American Society for Precision Engineering](https://aspe.net/programs/39th-aspe-annual-meeting/),  
and the extended-abstract volume is available in the proceedings:  
[ASPE 2024 Conference Proceedings (Proceedings.com)](https://www.proceedings.com/79023.html).
