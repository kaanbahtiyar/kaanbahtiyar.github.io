...
Peer-reviewed conference proceeding based on the spindle speed control for real-time vibration mitigation in machining processes project  (project page is available [here](/projects/spindle-speed-optimization/)).
