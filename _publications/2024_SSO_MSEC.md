...
Peer-reviewed conference proceeding based on the [spindle speed control for real-time vibration mitigation in milling project](/projects/spindle-speed-optimization/).
