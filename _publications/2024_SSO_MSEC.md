...
Peer-reviewed conference proceeding in the proceedings of the ASME International Manufacturing Science and Engineering Conference (MSEC 2024), based on the [spindle speed control for real-time vibration mitigation in machining processes](/projects/spindle-speed-optimization/) project.
